...
import { StateType as LoginStateType } from './model';
...
interface LoginTableListProps extends FormComponentProps {
  dispatch: Dispatch<Action<'loggerLogin/details' | 'loggerLogin/fetch' | 'loggerLogin/empty'>>;
  loading: boolean;
  loggerLogin: LoginStateType;
}
...
@connect(
  ({
    ...
    loggerLogin,
    loading: loading.models.loggerLogin,
  }),
)
/**
 * 日志管理
